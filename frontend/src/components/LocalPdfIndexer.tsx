...
type Props = {
  onTOCGenerated: (toc: TOCResult) => void;
        ...
        {showProgress ? (
          ...
          <div className="upload-state">
            ...
            <span className="upload-text">
              {pyodideError ? "Initialization failed" : "Drop PDF or click to browse"}
            </span>
            <span className="upload-hint">Max 25MB - Processed locally</span>
          </div>
        )}
      </div>
